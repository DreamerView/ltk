    ...
    return(
        <section className="welcomePage">
            <div className="welcomePageBlock">
                <p>Light Technology Kazakhstan - ваш надежный партнер в сфере АСУТП.</p>
                <div>
                    <h1>Ваши процессы. <div id="change">
                        <span>Автоматизировано.</span>
                        <span>Управляемо.</span>
                        <span>Контролируемо.</span>
                        </div></h1>
                ...
                <div className="buttonAction">
                    <a title="Подробнее" href="#reference" className="btn-2">Подробнее
                    ...
                    <a title="Свяжитесь с нами" href="#footer" className="btn-1">Свяжитесь с нами
